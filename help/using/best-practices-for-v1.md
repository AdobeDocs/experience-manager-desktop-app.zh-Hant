...
* **使用正確設定的Dispatcher**。 使用AEM Dispatcher以獲得額外的安全性，並確保它已設定為可在Dispatcher](install-configure-app-v1.md#connect-to-an-aem-instance-behind-a-dispatcher)後與AEM進行[AEM案頭應用程式連線
